...
// Team 11
#define reg_team_11_EN (*(volatile uint32_t*)0x300B0000)
...
void main()
{
	...
	reg_gpio_PIN_0TO7 = 0xBBBBBBBB;
	reg_gpio_PIN_8TO15 = 0xBBBBBBBB;
	reg_gpio_PIN_16TO23 = 0xBBBBBBBB;
	reg_gpio_PIN_24TO31 = 0xBBBBBBBB;
	reg_gpio_PIN_32TO37 = 0xBBBBBB;
