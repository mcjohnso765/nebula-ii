...
void main()
{
	...
	*/
	...
	reg_mprj_io_0 =  GPIO_MODE_USER_STD_INPUT;
	reg_mprj_io_5 = GPIO_MODE_USER_STD_INPUT;
    reg_mprj_io_6 = GPIO_MODE_USER_STD_INPUT;
	...
	reg_gpio_PIN_0TO7 = 0xCCCCCCCC;
	reg_gpio_PIN_8TO15 = 0xCCCCCCCC;
	reg_gpio_PIN_16TO23 = 0xCCCCCCCC;
	reg_gpio_PIN_24TO31 = 0xCCCCCCCC;
	reg_gpio_PIN_32TO37 = 0xCCCCCC;
