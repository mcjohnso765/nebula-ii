...
void main()
{
	...
	*/
	...
	reg_mprj_io_0 = GPIO_MODE_USER_STD_INPUT_PULLDOWN; // GPIO_MODE_USER_STD_OUTPUT;
	...
	reg_gpio_PIN_0TO7 = 0xAAAAAAAA;
	reg_gpio_PIN_8TO15 = 0xAAAAAAAA;
	reg_gpio_PIN_16TO23 = 0xAAAAAAAA;
